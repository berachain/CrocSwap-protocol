...
contract TestLiquidityMath {
    ...
    function testBlendMileage(uint64 mileageX, uint128 liqX, uint64 mileageY, uint128 liqY)
        public
        pure
        returns (uint64)
    {
    ...
    function testBlendMileage72(uint72 mileageX, uint128 liqX, uint72 mileageY, uint128 liqY)
        public
        pure
        returns (uint72)
    {
