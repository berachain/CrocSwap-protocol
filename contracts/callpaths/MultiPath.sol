...
contract MultiPath is ProxyCaller {
    function userCmd(bytes calldata cmd) public payable {
        ...
        if (cmdCode == 2) {
            ...
            (, uint8 code1, bytes memory cmd1, uint8 code2, bytes memory cmd2, uint8 code3, bytes memory cmd3) =
            ...
            (
                ...
                uint8 code4,
                bytes memory cmd4
            ) = abi.decode(cmd, (uint8, uint8, bytes, uint8, bytes, uint8, bytes, uint8, bytes));
            callUserCmdMem(code1, cmd1);
            callUserCmdMem(code2, cmd2);
            callUserCmdMem(code3, cmd3);
            ...
            (
                ...
                uint8 code5,
                bytes memory cmd5
            ) = abi.decode(cmd, (uint8, uint8, bytes, uint8, bytes, uint8, bytes, uint8, bytes, uint8, bytes));
            callUserCmdMem(code1, cmd1);
            callUserCmdMem(code2, cmd2);
            callUserCmdMem(code3, cmd3);
            callUserCmdMem(code4, cmd4);
