...
contract CrocImpact {
    ...
    function calcImpact(
        ...
        PoolSpecs.PoolCursor memory pool = queryPoolCntx(base, quote, poolIdx, poolTip);
    ...
    function adjTickLiq(
        ...
        unchecked {
            ...
            return swap.isBuy_ ? bumpTick : bumpTick - 1; // Valid ticks are well above {min(int128)-1}
        }
    }
